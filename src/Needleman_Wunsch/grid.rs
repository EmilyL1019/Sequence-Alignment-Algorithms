...
pub fn create_grid<'a>(mut seq1: &'a mut String, mut seq2: &'a mut String, len1: i32, len2: i32) -> (Vec<i32>, Vec<Direction>) {
    ...
    let mut i = 0;
    while i < total_cells {
        (score_grid, directions) = max_cell_score(&mut seq1, &mut seq2, &mut score_grid, &i, &mut directions);
        i = i + 1;
    }
...
fn max_cell_score<'a>(seq1: &'a mut String, seq2: &'a mut String, score_grid: &'a mut Vec<i32>, cell: &'a i32, directions: &'a mut Vec<Direction>) -> (Vec<i32>, Vec<Direction>) {
